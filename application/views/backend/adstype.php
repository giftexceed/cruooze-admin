                ...
                <tr>
                         ...
                         if(!empty($list->num_rows())) 
                  {
                   ...
                   <td><a href="#edit-popup<?php echo $item['id'];?>" data-bs-toggle="modal"><button class="btn btn--primary btn--shadow btn-sm bal-btn">Edit</button></a></td>
                         ...
                         <td><a href="<?php echo adminController();?>deleteAdstype/<?php echo $item['id']; ?>" onclick="return confirm('You are about to remove this item');"><button class="btn btn--danger btn--shadow w-100 btn-lg bal-btn">Delete</button></td>
                      </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Adstype  </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
                <div class="modal-body">
                  <form action="<?php echo adminController();?>editAdstype" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <label>Ads Type</label>
                                <input type="text" value="<?php echo $item['type'];?>" name="adstype" class="form-control">
...
<div id="addNew" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form action="<?php echo adminController();?>addAdstype" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <label>Ads Type</label>
                                <input type="text" value="" name="adstype" class="form-control">
