        ...
        <thead style="background-color: gray;">
                <tr>
                    <th style="color: #fff;">SN</th>
                          <th style="color: #fff;">Ads Type</th>
                         ...
                         if(!empty($list->num_rows())) 
                  {
                    ...
                    ?>
                        ...
                        <td><?php echo $count++;?></td>
                          <td><?php echo $item['activities'];?></td>
                   ...
                   <td><a href="#edit-popup<?php echo $item['id'];?>" data-bs-toggle="modal"><button class="btn btn--primary btn--shadow btn-sm bal-btn">Edit</button></a></td>
                         ...
                         <td><a href="<?php echo adminController();?>deleteAdsactivities/<?php echo $item['id']; ?>" onclick="return confirm('You are about to remove this item');"><button class="btn btn--danger btn--shadow w-100 btn-lg bal-btn">Delete</button></td>
                      </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit <?php echo $item['activities'];?>  </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
                <div class="modal-body">
                  <form action="<?php echo adminController();?>editActivities" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <label>Ads Type</label>
                                <input type="text" value="<?php echo $item['activities'];?>" name="activities" class="form-control">
                                 <input type="hidden" value="<?php echo $item['id'];?>" name="id" class="form-control">
                            </div>
...
<div id="addNew" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form action="<?php echo adminController();?>addActivities" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <label>Ads Actvities</label>
                                <input type="text" value="" name="adsactivities" class="form-control">
...
function postData(el) {
    ...
    $.ajax({
    url:'<?php echo adminController();?>updateactivities',
    method:"POST",
    data:{id:id},
