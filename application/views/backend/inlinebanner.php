        ...
        <thead style="background-color: gray;">
                ...
                <tr>
                         ...
                         if(!empty($data)) 
                  {
                    ...
                    ?>
                        ...
                        <td><?php echo $count++;?></td>
                          <td><img src="<?php echo $item['fileurl'];?>" width="150"></td>
                  ...
                  <td><a href="#edit-popup<?php echo $item['id'];?>" data-bs-toggle="modal"><button class="btn btn--primary btn--shadow btn-sm bal-btn">Edit</button></a></td>
                         <td><a href="<?php echo adminController();?>deleteinlineBanner/<?php echo $item['id']; ?>" onclick="return confirm('You are about to remove this banner');"><button class="btn btn--danger btn--shadow w-100 btn-lg bal-btn">Delete</button></td>
                      </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div><img src="<?php echo $item['fileurl'];?>" width="150"></div>
                 <form action="<?php echo adminController();?>editinlineBanner" enctype="multipart/form-data" method="POST">
...
<div id="addNew" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form action="<?php echo adminController();?>addinlineBanner" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <label>Browse file</label>
                                <input type="file" value="" name="imagefile" class="form-control">
...
function postData(el) {
    ...
    $.ajax({
    url:'<?php echo adminController();?>updateinlineBanner',
    method:"POST",
    data:{id:id},
