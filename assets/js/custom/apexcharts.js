(function() {
    ...
    if (getPerformanceOverviewId) {
        var options = {
            ...
            colors: [
                '#FC7013', '#2ECC71', '#8695AA', '#00CAE3', '#8695AA', '#2AA9FF'
            ],
            dataLabels: {
                enabled: false
            },
    ...
    if (getSalaryStatisticsId) {
        ...
        var options = {
			...
			colors: ["#E0AE33", "#030962", "#E0AE33", "#030962", "#E74C3C", "#E0AE33", "#030962"],
			plotOptions: {
				bar: {
					columnWidth: "62%",
