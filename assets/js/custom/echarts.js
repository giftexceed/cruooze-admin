(function() {
	...
	if (getCampingPerformanceId) {
        ...
        option = {
            ...
            color: ['#E0AE33', '#1CDFF4', '#030962', '#FFB264', '#E74C3C'],
            series: [
                {
                    ...
                    center: ['50%', '35%'],
                    data: [
                        { value: 50, name: 'Data Science' },
                        { value: 20, name: 'Business Analysis Program' },
                        { value: 15, name: 'Data Engineering Program' },
                        { value: 10, name: 'Corporate Governance Program' },
                        { value: 5, name: 'Data Protection Program' }
                    ],
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
            ...
            series: [
                {
                    ...
                    data: [
                        { value: 1048, name: 'Cybersecurity Program' },
                        { value: 735, name: 'Data Analytics Program' },
                        { value: 580, name: 'Business Analysis Program' },
                        { value: 484, name: 'Financial Analytics Program' },
                        { value: 300, name: 'Data Engineering Program' }
                    ]
                }
            ]
        };
